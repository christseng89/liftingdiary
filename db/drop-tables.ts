...
async function dropTables() {
  try {
    ...
    await sql`DROP TABLE IF EXISTS exercise_sets CASCADE`;
    console.log("✅ Dropped: exercise_sets");
    ...
    await sql`DROP TABLE IF EXISTS exercise_definitions CASCADE`;
    console.log("✅ Dropped: exercise_definitions");
